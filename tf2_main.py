...
parser.add_argument('--checkpoint_full_dir', dest='checkpoint_full_dir', default=None, help='models are saved here for test')
parser.add_argument('--sample_dir', dest='sample_dir', default='./samples', help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='./test', help='test sample are saved here')
parser.add_argument('--test_full_dir', dest='test_full_dir', default=None, help='test sample are saved here')
